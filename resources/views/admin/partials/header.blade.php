    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{ route('admin') }}">
                    <img src="{{ asset('/admins/img/icono-white.png') }}" class="navbar-logo" alt="Icono de Bitthrem" title="Icono de Bitthrem">
                </a>
            </li>
            <li class="nav-item theme-text" style="width: 150px;">
                <a href="{{ route('admin') }}">
                    <img src="{{ asset('/admins/img/logo-white.png') }}" class="w-100 mb-1" alt="Logo de Bitthrem" title="Logo de Bitthrem">
                </a>
            </li>
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="{{ image_exist('/admins/img/users/', Auth::user()->photo, true) }}" class="img-fluid mr-2" alt="avatar">
